...
if (true) {// isset= permet de voir si une variable est définie
  ...
  if (isset($_POST['mail'])) {
    ...
    $client= new profil_clientModel(['id' => $_POST['id'] , 'civilite' =>"mme",'nom' => htmlspecialchars($_POST['nom']),'prenom' =>  htmlspecialchars($_POST['prenom']),'date_de_naissance' =>  (date)($_POST['date_de_naissance']),
