...
if (isset($_POST['profil_client']) && $_POST['profil_client'] == 'profil_client') {// isset= permet de voir si une variable est définie
	 ...
	 if ((isset($_POST['civilite']) && !empty($_POST['civilite'])) && ((isset($_POST['nom']) && !empty($_POST['nom'])) && (isset($_POST['prenom']) && !empty($_POST['prenom'])) ((isset($_POST['nom']) && !empty($_POST['nom'])) && (isset($_POST['mdp_confirm']) && !empty($_POST['mdp_confirm']))) {
